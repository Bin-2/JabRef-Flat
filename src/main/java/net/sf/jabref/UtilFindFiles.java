...
public class UtilFindFiles {
     ...
     * @param directory A set of root directories to start the search from.
     * Paths are returned relative to these directories if relative is set to
     * true. These directories will not be expanded or anything. Use the file
     * attribute for this.
     * @param file non-null
     *
