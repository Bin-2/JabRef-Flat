...
public class FieldContentSelector extends JComponent {
     ...
     * @param editor The entry editor which will be appended by the text
     * selected by the user from the combobox.
     * @param metaData The metadata that contains the list of items to display
     * in the combobox under the key Globals.SELECTOR_META_PREFIX +
     * editor.getFieldName().
     ...
     * @param horizontalLayout Whether to put a 2 pixel horizontal strut between
     * combobox and button.
     */
