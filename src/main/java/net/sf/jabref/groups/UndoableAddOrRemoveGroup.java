...
class UndoableAddOrRemoveGroup extends AbstractUndoableEdit {
     ...
     * REMOVE_NODE_AND_CHILDREN)
     * @param editedNode The edited node (which was added or will be removed).
     * The node must be a descendant of node <b>groupsRoot</b>! This means that,
     * in case of adding, you first have to add it to the tree, then call this
     * constructor. When removing, you first have to call this constructor, then
     * remove the node.
     */
