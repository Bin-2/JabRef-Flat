...
public class UndoableModifySubtree extends AbstractUndoableEdit {
     ...
     */
    private List<TreeNode> m_modifiedSubtree = new ArrayList<>();
     ...
     * @param groupSelector
     * @param groupRoot
     * @param subtree The root node of the subtree that was modified (this node
     * may not be modified, it is just used as a convenience handle).
     * @param name
     */
