...
public abstract class AbstractGroup {
     ...
     * INCLUDING). Defaults to INDEPENDENT, which will be used if and only if
     * the context specified in the constructor is invalid.
     */
     ...
     * @throws Exception If an error occured and a group could not be created,
     ...
     * result of this operation, an object is returned that allows to undo this
     * change. null is returned otherwise.
     */
    ...
    /**
     * Sets the groups's hierarchical context. If context is not a valid value,
     * the call is ignored.
     */
    ...
    /**
     * Returns a lengthy textual description of this instance (for the groups
     * editor). The text is formatted in HTML.
     */
     ...
     * is applied to a different BibtexDatabase than it was created for. This is
     * for instance used when updating the group tree due to an external change.
     *
