...
public class CustomEntryType extends BibtexEntryType {
    ...
    public CustomEntryType(String name_, String[] req_, String[] opt_, String[] opt2_) {
        ...
        opt = allOpt.toArray(new String[0]);
        priOpt = opt_;
    }
    ...
    protected void parseRequiredFields(String[] parts) {
        ...
        req = fields.toArray(new String[0]);
        if (!sets.isEmpty()) {
            reqSets = sets.toArray(new String[0][]);
        }
    }
    ...
    /**
     * Check whether this entry's required fields are set, taking
     * crossreferenced entries and either-or fields into account:
     *
     ...
     *
     * @return Description of required field set for storage in preferences or
     * bib file.
     */
