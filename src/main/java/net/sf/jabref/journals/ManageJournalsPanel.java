...
/**
 * Created by IntelliJ IDEA. User: alver Date: Sep 19, 2005 Time: 7:57:29 PM To
    ...
    public boolean readyToClose() {
        ...
        if (newFile.isSelected()) {
            if (newNameTf.getText().length() > 0) {
                ...
                return (!f.exists()
                        || (JOptionPane.showConfirmDialog(this, "'" + f.getName() + "' " + Globals.lang("exists. Overwrite file?"),
