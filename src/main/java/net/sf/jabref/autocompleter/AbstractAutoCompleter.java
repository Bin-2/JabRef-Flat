...
public abstract class AbstractAutoCompleter {
    ...
    /**
     * States whether the field consists of multiple values (false) or of a
     * single value (true)
     *
     * Symptom: if false,
     * {@link net.sf.jabref.gui.AutoCompleteListener#getCurrentWord(JTextComponent comp)}
     * returns current word only, if true, it returns the text beginning from
     * the buffer
     */
