...
public abstract class Change extends DefaultMutableTreeNode {
    ...
    /**
     * This method is used to disable the "accept" box if the parent has been
     * set to "not accepted". Thus the user can disable e.g. an entry change
     * without having to disable all field changes.
     *
    ...
    /**
     * Perform the change. This method is responsible for adding a proper undo
     * edit to the NamedCompound, so the change can be undone.
     *
