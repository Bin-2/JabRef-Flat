 ...
 * @author ifsteinm.
 *
 * Jan 20th Abstract Class to provide main features to import entries from a DB.
 ...
 * the GUI). This class and its subclasses import database, entries and related
 * stuff from a DB to bib. Each exported database is imported as a new JabRef
...
public abstract class DBImporter extends DBImporterExporter {
     ...
     * ArrayList stores three Objects: a BibtexDatabase, a MetaData and a String
     * with the bib database name stored in the DBMS
     * @throws Exception
     */
