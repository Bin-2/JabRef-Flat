 ...
 * @author pattonlk
 *
 * Reestructured by ifsteinm. Jan 20th Now it is possible to export more than
 * one jabref database. BD creation, insertions and queries where reformulated
 * to accomodate the changes. The changes include a refactory on import/export
 * to SQL module, creating many other classes making them more readable This
 * class just support Exporters and Importers
 */
public class SQLUtil {
     ...
     * @param datatype Specifies the SQL data type that the fields should take
     * on.
     ...
     * @param origList original list with the correct size filled with the
     ...
     * @param tableName String containing the name of the table you want to get
     * the results.
