...
public class Globals {
    ...
    /**
     * {@link Control} class allowing properties bundles to be in different
     * encodings.
     *
     * @see
     * <a href="http://stackoverflow.com/questions/4659929/how-to-use-utf-8-in-resource-properties-with-resourcebundle">utf-8
    ...
    public static int FUTURE_YEAR = 2050, // Needs to give a year definitely in the future.
    ...
    /**
     * Returns a reg exp pattern in the form (w1)|(w2)| ... wi are escaped if no
     * regex search is enabled
     */
     ...
     * (http://stackoverflow.com/a/10722260/873282) and use that in a
     * StreamHandler. As JabRef is compatible with Java6, we have to write our
     * own Handler
     */
    ...
    ////////////////////////////////////////////////////////////////////////////
    // --- THE NEW OBSERVER LAYER ---
    public interface PreferenceChangeListener {

        void preferenceChanged(String key, String newValue);
    }

    private static final List<PreferenceChangeListener> prefListeners = new CopyOnWriteArrayList<>();
    ...
    public static void removePreferenceChangeListener(PreferenceChangeListener l) {
        prefListeners.remove(l);
    }

    /**
     * Call this whenever a preference is updated
     */
    public static void notifyPreferenceChanged(String key, String newValue) {
        for (PreferenceChangeListener l : prefListeners) {
            try {
                l.preferenceChanged(key, newValue);
            } catch (Exception ex) {
                ex.printStackTrace();
            }
        }
