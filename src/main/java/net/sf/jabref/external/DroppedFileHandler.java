...
public class DroppedFileHandler {
     ...
     * @param localFile Indicate whether this is a local file, or a remote file
     * copied to a local temporary file.
     ...
     * @param edits An NamedCompound action this action is to be added to. If
     * none is given, the edit is added to the panel's undoManager.
     */
     ...
     * @param fileName The name of the source file.
     * @param fileType The FileType associated with the file.
     * @param toFile The destination filename. An existing path-component will
     * be removed.
