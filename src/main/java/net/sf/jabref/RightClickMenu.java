...
public class RightClickMenu extends JPopupMenu
    ...
    public RightClickMenu(BasePanel panel_, MetaData metaData_) {
        ...
        add(new AbstractAction(Globals.lang("Copy"), GUIGlobals.getIcon("copy")) {
        ...
        add(new AbstractAction(Globals.lang("Paste"), GUIGlobals.getIcon("paste")) {
            public void actionPerformed(ActionEvent e) {
                try {
        ...
        add(new AbstractAction(Globals.lang("Cut"), GUIGlobals.getIcon("cut")) {
            public void actionPerformed(ActionEvent e) {
                try {
        ...
        add(new AbstractAction(Globals.lang("Delete"), GUIGlobals.getIcon("delete")) {
            public void actionPerformed(ActionEvent e) {
        ...
        if (multiple) {
            ...
            if ((marked == null) || (marked.isEmpty())) {
                ...
                add(markSpecific);
                add(new AbstractAction(Globals.lang("Unmark entry"), GUIGlobals.getIcon("unmarkEntries")) {
                    public void actionPerformed(ActionEvent e) {
                        try {
                            panel.runCommand("unmarkEntries");
                        } catch (Throwable ex) {
    ...
    /**
     * Remove all types from the menu. Then cycle through all available types,
     * and add them.
     */
    ...
    /**
     * Remove all types from the menu. Then cycle through all available values,
     * and add them.
     */
