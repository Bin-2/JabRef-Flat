 ...
 *
 * The list of optional and required fields is derived from
...
public abstract class BibtexEntryType implements Comparable<BibtexEntryType> {
    ...
    /**
     * This type is used for IEEEtran.bst to control various be repeated or not.
    ...
    /**
     * This method returns the standard BibtexEntryType for the name of a type,
    ...
    /**
     * Removes a customized entry type from the type map. If this type overrode
    ...
    /**
     * Get an array of the required fields in a form appropriate for the entry
     * customization dialog - that is, thie either-or fields together and
     * separated by slashes.
     *
     * @return Array of the required fields in a form appropriate for the entry
