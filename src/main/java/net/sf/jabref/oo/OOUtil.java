...
public class OOUtil {
     ...
     * @param uniquefier Uniqiefier letter, if any, to append to the entry's
     * year.
     * @throws Exception
     */
    ...
    /**
     * Make a cloned BibtexEntry and do the necessary preprocessing for use by
     * the plugin. If the running JabRef version doesn't support post-processing
     * in Layout, this preprocessing includes running the OOPreFormatter
     * formatter for all fields except the BibTeX key.
     *
