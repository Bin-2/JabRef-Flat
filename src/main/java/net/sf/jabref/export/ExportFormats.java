...
public class ExportFormats {
     ...
     *
     * @param maxLineLength The max line length before a line break must be
     * added.
     ...
     *
     * @return A Map containing all export formats, mapped to their console
     * names.
     */
     ...
     *
     * @param consoleName The export name given in the JabRef console help
     * information.
     ...
     * @param selectedOnly true indicates that only selected entries should be
     * exported, false indicates that all entries should be exported.
     * @return The action.
     */
