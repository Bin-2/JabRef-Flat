...
public class ExportFormat implements IExportFormat {
     ...
     * @param entryIds Contains the IDs of all entries that should be exported.
     * If <code>null</code>, all entries will be exported.
     *
     * @throws IOException if a problem occurred while trying to write to
     * {@code writer} or read from required resources.
     * @throws Exception if any other error occurred during export.
     *
     * @see
     * net.sf.jabref.export.IExportFormat#performExport(net.sf.jabref.BibtexDatabase,
     * net.sf.jabref.MetaData, java.lang.String, java.lang.String,
     * java.util.Set)
     */
    ...
    /**
     * See if there is a name formatter file bundled with this export format. If
     * so, read all the name formatters so they can be used by the filter
     * layouts.
     *
