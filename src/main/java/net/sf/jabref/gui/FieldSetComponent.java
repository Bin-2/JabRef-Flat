...
public class FieldSetComponent extends JPanel implements ActionListener {
     ...
     * Performs validation of the field.
     */
    ...
    /**
     * This method adds a new field to the list, without any regard to
     * validation. This method can be useful for classes that overrides
     * addField(s) to provide different validation.
     */
     ...
     * if changes have been made, regardless of whether the changes cancel each
     * other.
     */
    ...
    /**
     * Add a ListSelectionListener to the JList component displayed as part of
     * this component.
     */
    ...
    /**
     * Adds an ActionListener that will receive events each time a field is
     * added. The ActionEvent will specify this component as source, and the
     * added field as action command.
     */
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (src == add) {
            ...
            if (e.getActionCommand().equals("comboBoxChanged") && (e.getModifiers() == 0)) // These conditions signify arrow key navigation in the dropdown list, so we should
