...
public class FileListEditorTransferHandler extends TransferHandler {
     ...
     * @param textTransferHandler is an instance of
     * javax.swing.plaf.basic.BasicTextUI.TextTransferHandler. That class is not
     * visible. Therefore, we have to "cheat"
     */
     ...
     * COPY). COPY is supported as no support disables CTRL+C (copy of text)
     */
    @Override
