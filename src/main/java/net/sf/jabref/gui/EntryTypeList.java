...
/**
 * This class extends FieldSetComponent to provide some required functionality
 * for the list of entry types in EntryCustomizationDialog2.
 *
 * @author alver
 */
public class EntryTypeList extends FieldSetComponent implements ListSelectionListener, ActionListener {
    ...
    protected void removeSelected() {
        ...
        for (int i = 0; i < selected.length; i++) {
            ...
            } else // This shouldn't happen, since the Remove button should be disabled.
            {
