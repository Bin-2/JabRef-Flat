...
import net.sf.jabref.ThemeWatcher;

/**
 * Class defining the contents and column headers of the main table.
 */
public class MainTableFormat implements TableFormat<BibtexEntry>, ThemeAwareComponent {
    ...
    /**
     * This method returns a string array indicating the types of icons to be
     * displayed in the given column.It returns null if the column is not an
     * icon column, and thereby also serves to identify icon columns.
     *
     * @param col
     * @return
     */
