...
public class FromAuxDialog
    ...
    private JComboBox<String> dbChooser = new JComboBox<>();
    ...
    void parse_actionPerformed(ActionEvent e) {
        ...
        if (auxName != null) {
            if ((refBase != null) && (auxName.length() > 0)) {
                ...
                List<String> notFound = auxParser.generate(auxName, refBase);
                notFoundList.setListData(notFound.toArray(new String[0]));
