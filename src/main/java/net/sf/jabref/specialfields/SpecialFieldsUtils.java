...
public class SpecialFieldsUtils {
     ...
     * @param nullFieldIfValueIsTheSame - true: field is nulled if value is the
     * same than the current value in be
     */
     ...
     * @return an instance of that field. The returned object is a singleton.
     * null is returned if fieldName does not indicate a special field
     */
