...
public class SpecialFieldAction extends BaseAction {
    ...
    /**
     *
     * @param nullFieldIfValueIsTheSame - false also causes that doneTextPattern
     * has two place holders %0 for the value and %1 for the sum of entries
     * @param doneTextPattern - the pattern to use to update status information
     * shown in MainFrame
     */
