...
public class LabelPatternUtil {
     ...
     *
     * Replaces umlaut: \"x with xe, e.g. \"o -> oe, \"u -> ue, etc. Removes all
     * other diacritics: \?x -> x, e.g. \'a -> a, etc.
     *
     ...
     *
     * This is usable for distinguishing between persons and institutions in the
     * author or editor fields.
     *
     * A person: - "John Doe" - "Doe, John"
     *
     * An institution: - "{The Big Company or Institution Inc.}" - "{The Big
     * Company or Institution Inc. (BCI)}"
     *
     ...
     * <ul>
     * <li>If there is a university part use it otherwise use the rest
     * part.</li>
     ...
     * [field1]spacer[field2]spacer[field3]..., where the fields are the
     * (required) fields of a BibTex entry. The string is split into fields and
     * spacers by recognizing the [ and ].
     *
     * @param labelPattern a <code>String</code>
     * @return an <code>ArrayList</code> The first item of the list is a string
     * representation of the key pattern (the parameter), the remaining items
     * are the fields
     */
    ...
    /**
     * Generates a BibTeX label according to the pattern for a given entry type,
     * and returns the <code>Bibtexentry</code> with the unique label.
     *
    ...
    /**
     * Look up a field of a BibtexEntry, returning its String value, or an empty
     ...
     *
     * This method is private as it is currently used nowhere. The issue with
     * this method is that it uses the global variable "_db", which might be
     * undefined when calling the method.
     *
     ...
     * @return the surname of an author/editor or "" if no author was found This
     * method is guaranteed to never return null.
     *
     ...
     *
     * @param authorField a <code>String</code>
     * @return the first name initial of an author/editor or "" if no author was
     * found This method is guaranteed to never return null.
     *
     * @throws NullPointerException if authorField == null
     */
     ...
     *
     * @param authorField a <code>String</code>
     * @return the von part and surname of an author/editor or "" if no author
     * was found. This method is guaranteed to never return null.
     *
     * @throws NullPointerException if authorField == null
     */
     ...
     *
     * @param authorField a <code>String</code>
     * @return the forename initial of an author/editor or "" if no author was
     * found This method is guaranteed to never return null.
     *
     * @throws NullPointerException if authorField == null
     */
     ...
     * @return Gets the surnames of the first N authors and appends EtAl if
     * there are more than N authors
     */
    ...
    /**
     * Gets the first part of the last name of the first author/editor, and
     * appends the last name initial of the remaining authors/editors.
     *
     * @param authorField a <code>String</code>
     * @return the sur name of all authors/editors
     */
     ...
     * (1960) Isaac Newton and James Maxwell (1960) give: Newton.Maxwell.ea
     * Newton.Maxwell
     */
    ...
    /**
     * auth.etal, authEtAl, ... format: Isaac Newton and James Maxwell and
     * Albert Einstein (1960) Isaac Newton and James Maxwell (1960)
     *
     * auth.etal give (delim=".", append=".etal"): Newton.etal Newton.Maxwell
     *
     * authEtAl give (delim="", append="EtAl"): NewtonEtAl NewtonMaxwell
     */
    ...
    /**
     * authshort format: added by Kolja Brix, kbx@users.sourceforge.net
     *
     * given author names
     *
    ...
    /**
     * Parse a field marker with modifiers, possibly containing a parenthesised
     * modifier, as well as escaped colons and parentheses.
     *
