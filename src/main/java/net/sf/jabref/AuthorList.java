 ...
 * (<CODE>Character.isWhitespace(c)==true</CODE>), commas (,), dashes (-), and
 * tildas (~);
 ...
 * (<CODE>Character.isLetter(c)==true</CODE>) that does not belong to a sequence
 * of letters that immediately follows "\" character, with one exception: if "\"
 * is followed by "aa", "AA", "ae", "AE", "l", "L", "o", "O", "oe", "OE", "i",
 * or "j" followed by non-letter, the 'first letter' of a token is a letter that
 * follows "\"; for example: in "a{x}b" 'first letter' is "a", in "{\"{U}}bel"
 * 'first letter' is "U", in "{\noopsort{\"o}}xyz" 'first letter' is "o", in
 * "{\AE}x" 'first letter' is "A", in "\aex\ijk\Oe\j" 'first letter' is "j"; if
 * there is no letter satisfying the above rule, 'first letter' is undefined;
...
public class AuthorList {
     ...
     *
     * @param authors The string of authors or editors in bibtex format to
     * parse.
    ...
    private Author getAuthor() {
        ...
        // First step: collect tokens in 'tokens' and calculate indices
        token_loop:
        while (true) {
            int token = getToken();
            switch (token) {
    ...
    /**
     * Concatenates list of tokens from 'tokens'. Tokens are separated by spaces
     * or dashes, dependeing on stored in 'tokens'. Callers always ensure that
     * start < end; thus, there exists at least one token to be concatenated.
     *
     ...
     * <CODE>token_end</CODE>; thus, <CODE>token_end</CODE> has to be set to 0
     * before the first invocation. Procedure updates <CODE>token_end</CODE>;
     ...
     * additional information is given in global variables
     * <CODE>token_start</CODE>, <CODE>token_end</CODE>,
     * <CODE>token_abbr</CODE>, <CODE>token_term</CODE>, and
     * <CODE>token_case</CODE>; namely:
     * <CODE>orig.substring(token_start,token_end)</CODE> is the thext of the
     * token, <CODE>orig.substring(token_start,token_abbr)</CODE> is the token
     * abbreviation, <CODE>token_term</CODE> contains token terminator (space or
     * dash), and <CODE>token_case</CODE> is <CODE>true</CODE>, if token is
     * upper-case and <CODE>false</CODE> if token is lower-case.
     *
     * @return <CODE>TOKEN_EOF</CODE> -- no more tokens,
     * <CODE>TOKEN_COMMA</CODE> -- token is comma, <CODE>TOKEN_AND</CODE> --
     * token is the word "and" (or "And", or "aND", etc.),
     * <CODE>TOKEN_WORD</CODE> -- token is a word; additional information is
     * given in global variables <CODE>token_start</CODE>,
     * <CODE>token_end</CODE>, <CODE>token_abbr</CODE>, <CODE>token_term</CODE>,
     * and <CODE>token_case</CODE>.
     */
    private int getToken() {
        ...
        while (token_end < orig.length()) {
            ...
            if (!first_letter_is_found && current_backslash < 0 && Character.isLetter(c)) {
                ...
                } else // If this is a particle in braces, always treat it as if it starts with
     ...
     *
     * @see <a href="http://en.wikipedia.org/wiki/Serial_comma">serial comma for
     * an detailed explaination about the Oxford comma.</a>
     *
     * @return formatted list of authors.
     */
     ...
     * <li>"John Smith and Black Brown, Peter" ==> "Smith, John and Black Brown,
     * Peter"</li>
     * <li>"John von Neumann and John Smith and Black Brown, Peter" ==> "von
    ...
    /**
     * Compare this object with the given one.Will return true iff the other
     * object is an Author and all fields are identical on a string comparison.
     *
     * @param o
     */
    @Override
     ...
     * <code>getFirstLast</code>, and <code>getLastFirst</code> are used; all
     * other methods are provided for completeness.
     */
    public static class Author {
        ...
        /**
         * Compare this object with the given one.Will return true iff the other
         * object is an Author and all fields are identical on a string
         * comparison.
         *
         * @param o
         */
        ...
        /**
         * Creates the Author object. If any part of the name is absent,
         * <CODE>null</CODE> must be passed; otherwise other methods may return
         * erroneous results.
         *
         * @param first the first name of the author (may consist of several
         * tokens, like "Charles Louis Xavier Joseph" in "Charles Louis Xavier
         * Joseph de la Vall{\'e}e Poussin")
         * @param firstabbr the abbreviated first name of the author (may
         * consist of several tokens, like "C. L. X. J." in "Charles Louis
         * Xavier Joseph de la Vall{\'e}e Poussin"). It is a responsibility of
         * the caller to create a reasonable abbreviation of the first name.
         * @param von the von part of the author's name (may consist of several
         * tokens, like "de la" in "Charles Louis Xavier Joseph de la Vall{\'e}e
         * Poussin")
         * @param last the lats name of the author (may consist of several
         * tokens, like "Vall{\'e}e Poussin" in "Charles Louis Xavier Joseph de
         * la Vall{\'e}e Poussin")
         ...
         *
         * E.g., * {Vall{\'e}e Poussin} -> Vall{\'e}e Poussin * {Vall{\'e}e}
         * {Poussin} -> Vall{\'e}e Poussin * Vall{\'e}e Poussin -> Vall{\'e}e
         * Poussin
         */
         ...
         * @return 'von Last, Jr., First' (if <CODE>abbr==false</CODE>) or 'von
         * Last, Jr., F.' (if <CODE>abbr==true</CODE>)
         */
