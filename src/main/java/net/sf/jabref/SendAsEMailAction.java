 ...
 *
 * Microsoft Outlook does not support attachments via mailto Therefore, the
 * folder(s), where the file(s) belonging to the entry are stored, are opened.
 * This feature is disabled by default and can be switched on at
