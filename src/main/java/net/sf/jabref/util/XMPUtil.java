...
public class XMPUtil {
     ...
     * @param database maybenull An optional database which the given bibtex
     * entries belong to, which will be used to resolve strings. If the database
     * is null the strings will not be resolved.
     * @throws TransformerException If the entry was malformed or unsupported.
     * @throws IOException If the file could not be written to or could not be
     * found.
     */
     ...
     *
     * @throws IOException Throws an IOException if the file cannot be read, so
     * the user than remove a lock or cancel the operation.
     */
     ...
     *
     * @param di The document information from which to build a BibtexEntry.
     *
     ...
     *
     * @param dcSchema The document information from which to build a
     * BibtexEntry.
     *
     * @return The bibtex entry found in the document information.
     */
     ...
     * entries belong to, which will be used to resolve strings. If the database
     * is null the strings will not be resolved.
     * @throws TransformerException Thrown if the bibtexEntries could not
     * transformed to XMP.
     * @throws IOException Thrown if an IOException occured while writing to the
     * stream.
     *
     * @see #toXMP(java.util.Collection, net.sf.jabref.BibtexDatabase) if you
     * don't need strings to be resolved.
     */
     ...
     * @throws IOException If any of the given files could not be read or
     * written.
     * @throws TransformerException If the given BibtexEntry is malformed.
     */
     ...
     * itself from the PDF.
     *
     * @param is The inputstream to read the PDF from.
