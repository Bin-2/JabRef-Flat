...
public class QuotedStringTokenizer {
     ...
     * @param quoteCharacter The quoting character. Every character (including,
     * but not limited to, delimiters) that is preceded by this character is not
     * treated as a delimiter, but as a token component.
     */
