...
/**
 * Implement this interface to add another activeFetcher (something that grabs
 * records from the Web for JabRef). Have a look at the existing implemenations
...
public interface EntryFetcher extends ImportInspectionDialog.CallBack {
     ...
     * @param status An OutputPrinter passed to the activeFetcher for reporting
     * about the status of the fetching.
     *
    ...
    /**
     * The title for this activeFetcher, displayed in the menu and in the side
     * pane.
     *
     * @return The title
     */
     ...
     * the help page.
     *
     * @return The name of the help file or null if this activeFetcher does not
     * have any help.
     */
    public String getHelpPage();

    /**
     * If this activeFetcher requires additional options, a panel for setting up
     * these should be returned in a JPanel by this method. This JPanel will be
     * added to the side pane component automatically.
     *
     * @return Options panel for this activeFetcher or null if this
     * activeFetcher does not have any options.
     */
