...
/**
 * Created by IntelliJ IDEA. User: alver Date: Oct 22, 2006 Time: 12:06:09 PM To
...
public class ImportFormats {
     ...
     * @param openInNew Indicate whether the action should open into a new
     * database or into the currently open one.
     * @return The action.
     */
