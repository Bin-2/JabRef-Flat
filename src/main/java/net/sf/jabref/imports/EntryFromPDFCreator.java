...
/**
 * Uses XMPUtils to get one BibtexEntry for a PDF-File. Also imports the non-XMP
 * Data (PDDocument-Information) using
 * XMPUtil.getBibtexEntryFromDocumentInformation. If data from more than one
 * entry is read by XMPUtil then this entys are merged into one.
 *
 * @author Dan
