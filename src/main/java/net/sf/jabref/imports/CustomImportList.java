 ...
 *
 * <p>
 * The collection can be stored and retrieved from Preferences. It is sorted by
 * the default order of {@link ImportFormat}.</p>
 */
public class CustomImportList extends TreeSet<CustomImportList.Importer> {
     ...
     *
     * <p>
     * Is also responsible for instantiating the class loader.</p>
     */
     ...
     *
     * <p>
     * If an old one equal to the new one was contained, the old one is
     * replaced.</p>
     *
