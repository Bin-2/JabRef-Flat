 ...
 *
 * <p>
 * <a href="http://www.repec.org">RePEc (Research Papers in Economics)</a>
 * is a collaborative effort of over 100 volunteers in 49 countries to enhance
 * the dissemination of research in economics. The heart of the project is a
 * decentralized database of working papers, journal articles and software
 * components. All RePEc material is freely available.</p>
 * At the time of writing RePEc holds over 300.000 items.</p>
 *
 * <p>
 * <a href="http://nep.repec.org">NEP (New Economic Papers)</a> is an
 * announcement service which filters information on new additions to RePEc into
 * edited reports. The goal is to provide subscribers with up-to-date
 * information to the research literature.</p>
 *
 * <p>
 * This importer is capable of importing NEP messages into JabRef.</p>
 *
 * <p>
 * There is no officially defined message format for NEP. NEP messages are
 * assumed to have (and almost always have) the form given by the following
 * semi-formal grammar:
 * <pre>
 * NEPMessage:
...
public class RepecNepImporter extends ImportFormat {
   ...
   * @see net.sf.jabref.imports.ImportFormat#isRecognizedFormat(java.io.InputStream)
     ...
     * <li>a keyword</li>
     * </ul>
     * is found. Whitespace at start or end of lines is trimmed except for one
     * blank character.</p>
     *
     * @return result
     */
    ...
    /**
     * if line starts with a string of the form 'x. ' and we are not in the
     * overview section, we have a working paper entry we are interested in
     */
