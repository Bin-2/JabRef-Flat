 ...
 * <br>
 * This class provides some functionality to search in a {@link BibtexDatabase}
 * for files. <br>
 * <br>
 *
 *
...
public class DatabaseFileLookup {
     ...
     *
     * @param aDatabase A {@link BibtexDatabase}.
     */
    ...
    /**
     * Returns whether the File <code>aFile</code> is present in the database as
     * an attached File to an {@link BibtexEntry}. <br>
     * <br>
     ...
     *
     * @param aFile A {@link File} Object.
     ...
     * <br>
     *
     * @param aFile A file that is searched in an bibtex-entry.
     * @param anEntry A bibtex-entry, in which the file is searched.
