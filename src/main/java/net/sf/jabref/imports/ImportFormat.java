...
public abstract class ImportFormat implements Comparable<ImportFormat> {
     ...
     * objects.
     *
     * This method can be called in two different contexts - either when
     * importing in a specified format, or when importing in unknown format. In
     * the latter case, JabRef cycles through all available import formats. No
     * error messages or feedback is displayed from individual import formats in
     * this case.
     *
     * If importing in a specified format, and null or an empty list is
     * returned, JabRef reports that no entries were found. If an IOException is
     * thrown, JabRef displays the exception's message in unmodified form.
     *
     * TODO the return type should be changed to "ParseResult" as the parser
     * could use a different encoding than the default encoding
     */
     ...
     *
     * @return comma separated list of extensions or <code>null</code> for the
     * default
     */
     ...
     *
     * <p>
     * Implementors of ImportFormats should override this. Ideally, it should
     * specify
     * <ul><li>
     * what kind of entries from what sources and based on what specification it
     * is able to import
     * </li><li>
     * by what criteria it {@link #isRecognizedFormat(InputStream) recognizes}
     * an import format
     * </li></ul>
     *
     ...
     *
     * <p>
     * For custom importers added dynamically to JabRef, this will be set
     * automatically by JabRef.</p>
     *
     ...
     *
     * <p>
     * Custom importers will have precedence over built-in importers.</p>
     *
