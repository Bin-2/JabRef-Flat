...
/**
 * Importer for the Refer/Endnote format. modified to use article number for
 * pages if pages are missing (some journals, e.g., Physical Review Letters,
 * don't use pages anymore)
 *
...
public class EndnoteImporter extends ImportFormat {
    ...
    /**
     * We must be careful about the author names, since they can be presented
     * differently by different sources. Normally each %A tag brings one name,
     * and we get the authors separated by " and ". This is the correct
     * behaviour. One source lists the names separated by comma, with a comma at
