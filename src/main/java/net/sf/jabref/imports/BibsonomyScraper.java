...
/**
 * Convenience class for getting BibTeX entries from the BibSonomy scraper, from
 * an URL pointing to an entry.
 */
public class BibsonomyScraper {
    ...
    /**
     * Return a BibtexEntry by looking up the given url from the BibSonomy
     * scraper.
     *
     * @param entryUrl
     * @return
