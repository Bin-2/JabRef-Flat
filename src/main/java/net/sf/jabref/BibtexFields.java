...
public class BibtexFields {
    ...
    private BibtexFields() {
        ...
        BibtexSingleField dummy = new BibtexSingleField("journal", true, GUIGlobals.SMALL_W);
        ...
        PUBLIC_FIELDS = pFields.toArray(new String[0]);
        // sort the entries
    ...
    /**
     * Read the "numericFields" string array from preferences, and activate
     * numeric sorting for all fields listed in the array. If an unknown field
     * name is included, add a field descriptor for the new field.
     */
    ...
    public static String[] getAllPrivateFieldNames() {
        ...
        return pFields.toArray(new String[0]);
    }
