...
/**
 * This class extends {@link AbstractAction} with the ability to set the
 * mnemonic key based on a '&' character inserted in front of the desired
 * mnemonic letter. This is done by setting the action's name using
 * putValue(NAME, actionname). This facilitates localized mnemonics.
 */
    ...
    public final void putValue(String key, Object value) {
        if (key.equals(Action.NAME)) {
            ...
            if (i >= 0) {
                ...
                super.putValue(Action.MNEMONIC_KEY, Integer.valueOf(mnemonic));
