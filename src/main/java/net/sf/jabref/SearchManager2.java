...
//        super(manager, GUIGlobals.getIconUrl("search"), Globals.lang("Search"));
        ...
        searchGen = new JCheckBoxMenuItem(Globals.lang("Search general fields"),
                Globals.prefs.getBoolean("searchGen"));
        searchAll = new JCheckBoxMenuItem(Globals.lang("Search all fields"),
                Globals.prefs.getBoolean("searchAll"));
        regExpSearch = new JCheckBoxMenuItem(Globals.lang("Use regular expressions"),
    ...
    protected void updateKeyListeners() {
        KeyListener[] __listeners = searchField.getKeyListeners();
        for (KeyListener listener : __listeners) {
    ...
    /**
     * force the search button to be large enough for the longer of the two
     * texts
     */
