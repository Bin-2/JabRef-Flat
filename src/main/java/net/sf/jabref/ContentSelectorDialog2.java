...
public class ContentSelectorDialog2 extends JDialog {
    ...
    HashMap<String, DefaultListModel<String>> wordListModels = new HashMap<>();
    ...
    private void initLayout() {
        ...
        wordPan.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(),
