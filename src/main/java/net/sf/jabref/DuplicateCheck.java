...
public class DuplicateCheck {
     ...
     * @param truncate if true, always truncate the longer of two words to be
     * compared to harmonize their length. If false, use interpolation to
     * harmonize the strings.
